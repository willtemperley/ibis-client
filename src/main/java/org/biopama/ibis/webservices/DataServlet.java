...
import org.biopama.ibis.webservices.writers.CsvResultWriter;
import org.biopama.ibis.webservices.writers.ResultWriter;
import org.biopama.ibis.webservices.writers.WritableSheet;
import org.biopama.ibis.webservices.writers.XSSFResultWriter;
...
public class DataServlet extends HttpServlet {
	...
	private Logger logger = LoggerFactory.getLogger(DataServlet.class);

	@Inject
	public DataServlet(Provider<EntityManager> emp, URISlicer uriSlicer) {
		this.emp = emp;
